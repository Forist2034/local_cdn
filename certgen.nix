    ...
    in
    {
      ...
      mkConfig =
        ...
        in
        {
          ...
          certificate = if cfg.certgen.enable then server_cert info else cfg.cert;
              ...
              types.submodule {
                options =
                  ...
                  in
                  {
                    ...
                    servers = mkOption {
                      type = types.attrsOf (types.submodule { options = cert_config; });
                      default = { };
                    };
                  };
              }
              ...
              mkService =
                { configFile }:
                {
                  ...
                  serviceConfig = {
                    ...
                    ExecStart = "${bin_drv}/bin/local_cdn-certgen ${configFile} \${STATE_DIRECTORY}/ca \${STATE_DIRECTORY}/servers \${STATE_DIRECTORY}/state.json";
